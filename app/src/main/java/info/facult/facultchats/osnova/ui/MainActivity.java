...
import info.facult.facultchats.osnova.adapters.ChatroomRecyclerAdapter;
...
import static info.facult.facultchats.osnova.Constants.ERROR_DIALOG_REQUEST;
import static info.facult.facultchats.osnova.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static info.facult.facultchats.osnova.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private UserLocations mUserLocation;
    ...
    private void getUserDetails(){
        if(mUserLocation == null){
            mUserLocation = new UserLocations();
