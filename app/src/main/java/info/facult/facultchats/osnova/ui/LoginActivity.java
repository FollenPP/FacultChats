...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String REDIRECT_URL_CALLBACK = "follenpp://git.oauth2token";
    private final String TAG = getClass().getName();
    private FirebaseAuth mAuth;
    private FirebaseAuth.AuthStateListener mAuthListener;
    private Button btnGit;
    private Button btnGit2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnNav = (Button) findViewById(R.id.btnGit2);

        btnNav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "Onclick: Clicked   btvNav.");

                Intent intent = new Intent(LoginActivity.this, LoginDB.class);
        ...
        btnGit2 = findViewById(R.id.btnGit2);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Picasso.with(LoginActivity.this).load(user.getPhotoUrl()).into(imgGit);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.startsWith("http://follenpp://git.")) {
    ...
    public void signInOut(View view) {
        if (!signed) {
            ...
            HttpUrl httpUrl = new HttpUrl.Builder()
                    ...
                    .addQueryParameter("client_id", "5f88b58715ed28a98253")
    ...
    private void sendPost(String code, String state) {
        ...
        FormBody form = new FormBody.Builder()
                .add("client_id", "5f88b58715ed28a98253")
                .add("client_secret", "77d7b9879fb190c2a1d46863aebfd88498ad432b")
                .add("code", code)
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
                Toast.makeText(LoginActivity.this, "onFailure: " + e.toString(), Toast.LENGTH_SHORT).show();
            }
